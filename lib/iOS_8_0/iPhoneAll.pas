...
uses
  ...
  GLES11,
  {$endif}
  DefinedClassesCoreFoundation, 
  DefinedClassesSecurity, 
  DefinedClassesFoundation, 
  DefinedClassesCoreGraphics, 
  DefinedClassesOpenGLES, 
  DefinedClassesCoreImage, 
  DefinedClassesCoreText, 
  DefinedClassesQuartzCore, 
  DefinedClassesUIKit, 
  DefinedClassesMobileCoreServices, 
  CFNetwork;
